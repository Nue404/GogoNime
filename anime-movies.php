...
<head>
    ...
    <title>List Anime Movies at Gogoanime</title>

    <meta name="robots" content="index, follow" />
    <meta name="description" content="List Anime Movies at Gogoanime">
    ...
    <meta property="og:title" content="List Anime Movies at Gogoanime" />
    <meta property="og:description" content="List Anime Movies at Gogoanime">
    <meta property="og:url" content="" />
    <meta property="og:image" content="<?=$base_url?>/img/logo.png" />
    <meta property="og:image:secure_url" content="<?=$base_url?>/img/logo.png" />

    <meta property="twitter:card" content="summary" />
    <meta property="twitter:title" content="List Anime Movies at Gogoanime" />
    <meta property="twitter:description" content="List Anime Movies at Gogoanime" />
                ...
                <section class="content">
                    <section class="content_left">
                        ...
                        <div class="main_body">
                            <div class="anime_name anime_movies">
                                ...
                                <div class="anime_name_pagination">
                                    <div class="pagination">
                                        ...
                                        <ul class='pagination-list'><?php $pagination = file_get_contents("$apiLink/moviePage/$page");$pagination = json_decode($pagination, true); echo str_replace("active","selected",$pagination['pagination']) ?>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="items">
                               <?php
                                   $json = file_get_contents("$apiLink/getMovies/$page");
